...
import Pinky from "../../Loading/Pinky";
...
class UpdateFlower extends Component {
    flowerUpdated = (e) => {
        ...
        this.props.onFlowerUpdate(updatedFlower, this.props.match.params.id);
        window.setTimeout(() => {
                                ...
                                <div className="row form-group mt-2">
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <input type="text" className="form-control" id="family" name={"family"}
                                               ...
                                               placeholder={this.props.location.update.family}>
                                        </input>
                                    </div>
                                </div>
                                <div className="row form-group mt-2">
                                    ...
                                    <div className="col-sm-6">
                                        <label htmlFor="giftDescription">Type</label>
                                        <input type="text" className="form-control" id="type" name={"type"}
                                               aria-describedby="type" placeholder={this.props.location.update.type}>
                                        </input>
                                    </div>
                                </div>
                                <div className="row form-group mt-2">
